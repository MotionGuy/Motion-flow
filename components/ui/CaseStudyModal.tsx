...
function NextSection({ label }: { label: string }) {
  return (
    <div className="mt-auto flex items-center justify-between gap-5 border-t border-line pt-6">
      ...
      >
        ...
        >
          ...
          >
            ...
            <section className="flex min-h-[520px] snap-start snap-always flex-col p-6 sm:p-9 lg:min-h-full">
              <p className="eyebrow">What was the challenge?</p>
              <p className="display mt-8 max-w-[18ch] text-3xl leading-[1.22] text-fg sm:text-4xl">{copy.challenge}</p>
              <NextSection label="Our approach" />
            </section>

            <section className="flex min-h-[520px] snap-start snap-always flex-col p-6 sm:p-9 lg:min-h-full">
              <p className="eyebrow">Our approach</p>
              <p className="display mt-8 max-w-[18ch] text-3xl leading-[1.22] text-fg sm:text-4xl">{copy.approach}</p>
              <NextSection label="Result" />
            </section>

            <section className="flex min-h-[520px] snap-start snap-always flex-col p-6 sm:p-9 lg:min-h-full">
              <p className="eyebrow">Result</p>
              <p className="display mt-8 max-w-[18ch] text-3xl leading-[1.22] text-fg sm:text-4xl">{copy.result}</p>
